  ...
  switch (id) {
    ...
    case 'ocean': {
      for (let r = 0; r < repeats; r++) {
        ...
        // push in a shape that stop() can handle
    ...
    case 'bell': {
      for (let r = 0; r < repeats; r++) {
        ...
        mod.start(t0); mod.stop(t0 + 3.6);
        carrier.start(t0); carrier.stop(t0 + 3.6);
